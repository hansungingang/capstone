...
@section('style')
    <link type="text/css" rel="stylesheet" href="{{asset('css/lecture/lecture-edit.css')}}">
@stop
@section('script')
    <script type="text/javascript" src="{{asset('js/lecture/lecture-edit.js')}}" charset="utf-8"></script>
    <script>
...
<form method="POST" action="{{ route('lecture.update',$lecture_id) }}" id="upload_lecture">
    @csrf
    @method('PUT')
    <div class="container">
        <div class="row">
